# MosKrypton
This is an API that allows kryptonians to register, authenticate, manage files, and access images. It includes a token-based authentication and API key management.
